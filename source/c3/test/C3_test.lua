...
function test_c3_param_decode()
  local param_data = { 0x7e, 0x53, 0x65, 0x72, 0x69, 0x61, 0x6c, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x3d, 0x35, 0x34,
                       0x31, 0x33, 0x33, 0x35, 0x34, 0x34, 0x30, 0x31, 0x35, 0x37, 0x39, 0x2c, 0x4c, 0x6f, 0x63, 0x6b,
                       0x43, 0x6f, 0x75, 0x6e, 0x74, 0x3d, 0x32, 0x2c, 0x52, 0x65, 0x61, 0x64, 0x65, 0x72, 0x43, 0x6f,
                       0x75, 0x6e, 0x74, 0x3d, 0x34, 0x2c, 0x41, 0x75, 0x78, 0x49, 0x6e, 0x43, 0x6f, 0x75, 0x6e, 0x74,
                       0x3d, 0x32, 0x2c, 0x41, 0x75, 0x78, 0x4f, 0x75, 0x74, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x3d, 0x32 }

  local params = C3.param_decode(param_data)
  lunit.assert_equal("5413354401579", params["~SerialNumber"])
  lunit.assert_equal("2",             params["LockCount"])
  lunit.assert_equal("4",             params["ReaderCount"])
  lunit.assert_equal("2",             params["AuxInCount"])
  lunit.assert_equal("2",             params["AuxOutCount"])
end
